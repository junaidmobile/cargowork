...
function clearALL() {
   ...
   // $('#ddlShipmntNo').val(0);
    ...
    var newOptionSN = $('<option></option>');
    newOptionSN.val(0).text('Select');
    newOptionSN.appendTo('#ddlShipmntNo');
    $('#ddlShipmntNo').val(0);
}
...
function AddTableLocation(index, LocationSeq, Location, Pieces, Weight) {
    ...
    html += "<td height='30' onclick='GetMeetingByNo(abc)'style='background: rgb(224, 243, 215);padding-left: 4px;font-size:14px'align='center'><input id=txtLocPcs_" + index + " class=form-control type=number style=text-align:right; value=" + Pieces + " onchange='CalculateWtVol(" + index + ");'></td>";
    html += "<td height='30' onclick='GetMeetingByNo(abc)'style='background: rgb(224, 243, 215);padding-left: 4px;font-size:14px; display:none;'align='center'><input id=txtHideLocPcs_" + index + " class=form-control type=number style=text-align:right; value=" + Pieces + "></td>";
    ...
    html += "<td height='30' onclick='GetMeetingByNo(abc)'style='background: rgb(224, 243, 215);padding-left: 4px;font-size:14px'align='center'><input id=txtLocWt_" + index + " class=form-control type=number style=text-align:right; value=" + Weight + "></td>";
    html += "<td height='30' onclick='GetMeetingByNo(abc)'style='background: rgb(224, 243, 215);padding-left: 4px;font-size:14px; display:none;'align='center'><input id=txtHideLocWt_" + index + " class=form-control type=number style=text-align:right; value=" + Weight + "></td>";
    html += "</tr>";
