...
function SaveUploadFile(imageData) {
    ...
    //commented by shruti on 02-march-2023
...
function GetAWBDetails(UldNo) {
    ...
    var ULDSeq = $('#ddlULDNo').find('option:selected').val().split("_");
                    ...
                    if (ULDSeq[1].toString() == "Y") {
                        lnv.confirm({
                            ...
                            confirmHandler: function () {
                                ...
                                var inputXML = '<Root><FlightSeqNo>' + FlightSeqNo + '</FlightSeqNo><UlDSeqNo>' + ULDSeq[0] + '</UlDSeqNo><AWBPREFIX>0</AWBPREFIX><AWBNO>0</AWBNO><SHIPNO>0</SHIPNO><HouseSeqNo>0</HouseSeqNo><NPR>0</NPR><RecWeight>0</RecWeight><UserId>' + UserId + '</UserId><AirportCity>' + AirportCity + '</AirportCity><IsInTact>Y</IsInTact></Root>';
...
function GetHAWBDetails(AWBid) {
    ...
    var inputXML = '<Root><AWBNo>' + AWBid + '</AWBNo><ShipNo>' + $('#ddlAWBNo').find('option:selected').val() + '</ShipNo><HouseSeqNo>0</HouseSeqNo><FlightSeqNo>' + FlightSeqNo + '</FlightSeqNo><ULDSeqNo>' + ULDSeq[0] + '</ULDSeqNo><AirportCity>' + AirportCity + '</AirportCity><UserId>' + UserId + '</UserId></Root>';
...
function SaveDetails() {
    ...
    var inputXML = '<Root><FlightSeqNo>' + FlightSeqNo + '</FlightSeqNo><UlDSeqNo>' + ULDSeq[0] + '</UlDSeqNo><AWBPREFIX>' + AWBPREFIX + '</AWBPREFIX><AWBNO>' + AWBNumber + '</AWBNO><SHIPNO>' + $('#ddlAWBNo').find('option:selected').val() + '</SHIPNO><HouseSeqNo>' + HAWBSeqNo + '</HouseSeqNo><NPR>' + Pckgs + '</NPR><RecWeight>' + Wt + '</RecWeight><UserId>' + UserId + '</UserId><AirportCity>' + AirportCity + '</AirportCity></Root>';
    //var inputXML = '<Root><FlightSeqNo>' + FlightSeqNo + '</FlightSeqNo><UlDSeqNo>' + $('#ddlULDNo').find('option:selected').val() + '</UlDSeqNo><AWBPREFIX>' + AWBPREFIX + '</AWBPREFIX><AWBNO>' + AWBNumber + '</AWBNO><SHIPNO>' + $('#ddlAWBNo').find('option:selected').val() + '</SHIPNO><HouseSeqNo>' + HAWBSeqNo + '</HouseSeqNo><NPR>' + Pckgs + '</NPR><RecWeight>' + Wt + '</RecWeight><UserId>' + UserId + '</UserId><AirportCity>' + AirportCity + '</AirportCity></Root>';
...
function SaveDamageDetails() {
    ...
    if (imageDataForArray.length > 0) {
        ...
        var MAWBNo = $('#txtAWBPrefixDam').val() + $('#txtAWBNoDam').val();
...
function GetMaterialList() {
    ...
    var inputXML = '<Root><MATERIAL_FOR>U</MATERIAL_FOR><Module>I</Module><ULDSeqNo>' + ULDSeq[0] + '</ULDSeqNo><FLTSeqNo>' + FlightSeqNo + '</FLTSeqNo><AirportCity>' + AirportCity + '</AirportCity><CompanyCode>' + window.localStorage.getItem("companyCode") + '</CompanyCode><UserID>' + window.localStorage.getItem("UserID") + '</UserID><ALCode>' + FlightPrefix + '</ALCode></Root>';
...
function GetMaterialUsed() {
    ...
    var inputXML = '<Root><MATERIAL_FOR>U</MATERIAL_FOR><MATERIAL_ID>' + $('#ddlMaterialType').find('option:selected').val() + '</MATERIAL_ID><Module>I</Module><ULDSeqNo>' + ULDSeq[0] + '</ULDSeqNo><FLTSeqNo>' + FlightSeqNo + '</FLTSeqNo><AirportCity>' + AirportCity + '</AirportCity><CompanyCode>' + window.localStorage.getItem("companyCode") + '</CompanyCode><UserID>' + window.localStorage.getItem("UserID") + '</UserID></Root>';
...
function SaveMaterialUsed() {
    ...
    var inputXML = '<Root><SEQ_NO>' + SEQ_NO + '</SEQ_NO><MATERIAL_FOR>U</MATERIAL_FOR><MATERIAL_ID>' + $('#ddlMaterialType').find('option:selected').val() + '</MATERIAL_ID><MATERIAL_UNIT>' + $('#txtNoUnits').val() + '</MATERIAL_UNIT><Module>I</Module><ULDSeqNo>' + ULDSeq[0] + '</ULDSeqNo><FLTSeqNo>' + FlightSeqNo + '</FLTSeqNo><AirportCity>' + AirportCity + '</AirportCity><CompanyCode>' + window.localStorage.getItem("companyCode") + '</CompanyCode><UserID>' + window.localStorage.getItem("UserID") + '</UserID></Root>';
    //var inputXML = '<Root><SEQ_NO>' + SEQ_NO + '</SEQ_NO><MATERIAL_FOR>U</MATERIAL_FOR><MATERIAL_ID>' + $('#ddlMaterialType').find('option:selected').val() + '</MATERIAL_ID><MATERIAL_UNIT>' + $('#txtNoUnits').val() + '</MATERIAL_UNIT><Module>I</Module><ULDSeqNo>' + $('#ddlULDNo').find('option:selected').val() + '</ULDSeqNo><FLTSeqNo>' + FlightSeqNo + '</FLTSeqNo><AirportCity>' + AirportCity + '</AirportCity><CompanyCode>' + window.localStorage.getItem("companyCode") + '</CompanyCode><UserID>' + window.localStorage.getItem("UserID") + '</UserID></Root>';
...
function SaveFoundCargoDetails() {
    ...
    var inputXML = '<Root><AWBPref>' + AWBPrefix + '</AWBPref><AWBNo>' + AWBNo + '</AWBNo><HouseNo></HouseNo><Pcs>' + $('#txtPackages').val() + '</Pcs><Wt>' + $('#txtWeight_FC').val() + '</Wt><Ori>' + $('#txtOrigin_FC').val() + '</Ori><Dest>' + $('#txtDestination_FC').val() + '</Dest><LocCode>' + $('#txtLocation_FC').val() + '</LocCode><FlightSeqNo>' + FlightSeqNo + '</FlightSeqNo><ULDSeqNo>' + ULDSeq[0] + '</ULDSeqNo><AirportCity>' + AirportCity + '</AirportCity><UserId>' + window.localStorage.getItem("UserID") + '</UserId><CompCode>' + window.localStorage.getItem("companyCode") + '</CompCode></Root>';
