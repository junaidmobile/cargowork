...
function GetExportCheckListNext(chkID) {
    ...
    var AwbPrefix = awbno.slice(0, 3);
    var AwbNumber = awbno.slice(3, 11);
    inputRowsOfAns = "";
    ...
    inputRowsOfAns += '<Root><CheckListType>' + chkID + '</CheckListType><AWBId>0</AWBId><AwbPrefix>' + AwbPrefix + '</AwbPrefix><AwbNumber>' + AwbNumber + '</AwbNumber><PageNo>' + PageNo + '</PageNo><PageNoDisplay></PageNoDisplay><AirportCity>' + AirportCity + '</AirportCity><UserId>' + UserID + '</UserId><Answers>'
