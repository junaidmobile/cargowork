...
function HHTGetDriverDetails() {
    ...
    var inputxml = '<Root><DriverType>P</DriverType><AirportCity>' + AirportCity + '</AirportCity></Root>';
...
function GetWDOdetailsByDriverDetails(license_plate_no) {
    ...
    var inputxml = '<Root><WDONo>' + license_plate_no + '</WDONo><RNo></RNo><CompanyCode>' + CompanyCode + '</CompanyCode><AirportCity>' + AirportCity + '</AirportCity></Root>';
